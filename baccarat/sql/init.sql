...
CREATE TABLE IF NOT EXISTS card_details (
    ...
    card_position ENUM('PlayerInitial1', 'PlayerInitial2', 'BankerInitial1', 'BankerInitial2', 'PlayerThird', 'BankerThird') NOT NULL,
    suit INT NOT NULL,  -- 0: Spades, 1: Hearts, 2: Diamonds, 3: Clubs
    value INT NOT NULL, -- 1-13
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
